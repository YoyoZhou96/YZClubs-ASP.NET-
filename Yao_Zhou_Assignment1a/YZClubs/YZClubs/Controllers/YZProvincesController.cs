...
{
    public class YZProvincesController : Controller
    {
        private readonly ClubsContext _context;

        public YZProvincesController(ClubsContext context)
        {
            _context = context;
        }
        ...
        {
            var clubsContext = _context.Province.Include(p => p.CountryCodeNavigation);
            return View(await clubsContext.ToListAsync());
        }

        // GET: YZProvinces/Details/5
